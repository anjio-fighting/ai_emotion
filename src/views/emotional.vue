  ...
  <div>
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column label="情绪评分" width="200">
        <template #default="scope">
          <!-- :model-value="scope.row.moodScore"是绑定到el-rate组件的评分值 disabled属性禁用评分组件 -->
        ...
        <div class="detail-section">
          ...
          <el-descriptions :column="1" border>
            ...
            <el-descriptions-item label="日记内容"
              >{{ currentDetail.diaryContent || "无" }}/5</el-descriptions-item
            >
          </el-descriptions>
        </div>
        <div class="detail-section">
...
const formItem = [
  ...
  },
  {
    ...
    placeholder: "请选择评分范围",
    options: [
      { label: "低分1-3", value: "1-3" },
      { label: "中分4-6", value: "4-6" },
      { label: "高分7-10", value: "7-10" },
    ],
  },
];
